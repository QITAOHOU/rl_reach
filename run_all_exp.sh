...
echo "env v3"
python run_experiments.py --exp-id 40 --algo ppo --env widowx_reacher-v3 --n-timesteps 1000000 --n-seeds 2
echo "env v9"
python run_experiments.py --exp-id 41 --algo ppo --env widowx_reacher-v9 --n-timesteps 1000000 --n-seeds 2
echo "env v10"
python run_experiments.py --exp-id 42 --algo ppo --env widowx_reacher-v10 --n-timesteps 1000000 --n-seeds 2
echo "env v11"
python run_experiments.py --exp-id 44 --algo ppo --env widowx_reacher-v11 --n-timesteps 1000000 --n-seeds 2
echo "env v12"
python run_experiments.py --exp-id 45 --algo ppo --env widowx_reacher-v12 --n-timesteps 1000000 --n-seeds 2
